...
logo() {
  ...
  echo "$COL_RED              ## ## ##       ==            $COL_END"
  echo "$COL_RED           ## ## ## ##      ===            $COL_END"
  echo "$COL_RED       /""""""""""""""""\___/ ===          $COL_END"
  echo "$COL_RED  ~~~ {~~ ~~~~ ~~~ ~~~~ ~~ ~ /  ===- ~~~   $COL_END"
  echo "$COL_RED      \______ o          __/               $COL_END"
  echo "$COL_RED        \    \        __/                  $COL_END"
  echo "$COL_RED         \____\______/                     $COL_END"
  echo "$COL_RED                                           $COL_END"
  echo "$COL_RED          |          |                     $COL_END"
  echo "$COL_RED       __ |  __   __ | _  __   _           $COL_END" 
  echo "$COL_RED      /  \| /  \ /   |/  / _\ |            $COL_END" 
  echo "$COL_RED      \__/| \__/ \__ |\_ \__  |            $COL_END"
  print_line1
